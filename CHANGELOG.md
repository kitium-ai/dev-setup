...
- Hardened idempotent installs with existing-tool detection and per-task telemetry hooks.
- Expanded README with API references and examples for enterprise rollout scenarios.
